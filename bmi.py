def bmi_index(bmi):
    ...
    if bmi < 18.5:
        messagebox.showinfo('bmi-Shashank', f'BMI = {bmi} is Underweight')
    elif (bmi > 18.5) and (bmi < 24.9):
        messagebox.showinfo('bmi-Shashank', f'BMI = {bmi} is Normal')
    elif (bmi > 24.9) and (bmi < 29.9):
        messagebox.showinfo('bmi-Shashank', f'BMI = {bmi} is Overweight')
    elif (bmi > 29.9):
        messagebox.showinfo('bmi-Shashank', f'BMI = {bmi} is Obesity') 
    else:
        messagebox.showerror('bmi-Shashank', 'something went wrong!')   
